...
const ServicesTabs: React.FC<ServicesTabsProps> = ({
  ...
  return (
    <section id={id} className="w-full max-w-[954px] 2xl:max-w-[1280px] px-4 sm:px-0">
              ...
              {serviceCategories.map((category) => {
                return (
                  <TabsTrigger
                    key={category.id}
                    value={category.id}
                    className={`flex-1 flex flex-col items-center gap-4 h-auto rounded-none min-w-[150px] max-w-[200px] 2xl:min-w-0 2xl:max-w-none`}
                  >
